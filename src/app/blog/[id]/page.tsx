  ...
  return (
    <section className="section-container bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="mt-8 text-2xl md:text-3xl font-heading font-bold text-primary-800">
          {post.title}
        </h1>
        ...
        <div className="mt-6">
          <p className="text-black leading-relaxed whitespace-pre-line">{post.description}</p>
        </div>
