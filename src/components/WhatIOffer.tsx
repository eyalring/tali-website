...
const offers: Offer[] = [
  ...
  },
  {
    ...
    description:
      "אני מעבירה הרצאות ומצגות חווייתיות המותאמות לתלמידי חטיבת הביניים ולתיכון הן כיתות רגילות והן מגמות ביולוגיה. ובהתאמה גם לימי עיון, ימי כיף והשתלמויות למורים",
